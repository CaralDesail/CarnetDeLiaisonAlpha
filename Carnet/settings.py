...
EMAIL_PORT = 5025
EMAIL_HOST_USER = 'devtemp@alaincarrot.com' #put here the email adress
EMAIL_HOST_PASSWORD = 'DevTPassds' # and here the password
...
TEMPLATES = [
    {
        ...
        'DIRS': [            # This line adds templates/ in project root
...
#will search in environment for other database and overload previous information
